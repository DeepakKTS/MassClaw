...
import {
  Crosshair, Bot, Brain, Shield, Trophy, FileText, Settings, FolderKanban, Wrench, Zap, UserCheck, Sparkles,
} from "lucide-react";
...
const DOCK_ITEMS = [
  ...
  { id: "intelligence", href: "/intelligence", icon: <Sparkles />, label: "Intelligence" },
];
